...
//******************************************************************	
    ...
    fout1 << " C. The values for each data file that are mostly different are: " << endl;
    fout1 << " D. Other statistical measures we would suggest are: sound waves, " <<endl;
    fout1 << " E.  By examining the data from both file we have determined the percentage difference is too great to concluded that voice captured is Maria Estrella "  << endl;
